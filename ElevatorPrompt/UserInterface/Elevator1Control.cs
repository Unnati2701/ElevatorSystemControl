...
{
    public class Elevator1Control : IElevatorControl
    {
        ...
        public Elevator1Control(IElevatorInput elevatorInput, IDriveControl driveControl, IDisplayMessages displayMessages)
        {
        ...
        {
            Console.WriteLine("Elevator 1 is assigned to floor {0}", nextFloor);
        }
